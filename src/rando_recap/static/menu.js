// Lightweight native-style context menu shown at the cursor on click, shared by
// the map's stop markers and the chart's rest bands. Only one menu can be open
// at a time (the module-level `activeMenu` singleton); it closes on outside
// click, Escape, or scroll/resize (positions go stale).
